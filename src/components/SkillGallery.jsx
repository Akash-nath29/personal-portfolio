...
export default function SkillGallery() {
  return (
    <div className="grid grid-cols-3 gap-5 h-1/2 w-full place-items-center">
      <div className="grid gap-4">
        <div>
          <img
            className="h-[60px] max-w-full rounded-lg bg-white p-3"
            src={Html}
            alt=""
          />
        </div>
      ...
      <div className="grid gap-4">
        ...
        <div>
          <img
            className="h-[60px] max-w-full w-[70px] rounded-lg bg-white p-3"
            src={Tailwind}
            alt=""
          />
        </div>
